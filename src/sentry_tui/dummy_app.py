...
LOG_MESSAGES = [
    ...
    ("webpack", "Hash: 9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08"),
    ...
    ("server", "  File \"/app/sentry/api/endpoints/project_events.py\", line 123, in get"),
...
class DummyApp:
    ...
    def _add_some_multiline_logs(self) -> List[str]:
        ...
        if random.random() < 0.1:  # 10% chance of multiline log
            ...
            lines = []
            lines.append(self._format_log_line(service, "Traceback (most recent call last):"))
            lines.append(self._format_log_line(service, "  File \"/app/sentry/models/event.py\", line 456, in process"))
            lines.append(self._format_log_line(service, "    event.save()"))
            lines.append(self._format_log_line(service, "  File \"/app/sentry/models/event.py\", line 234, in save"))
            lines.append(self._format_log_line(service, "    raise ValidationError(\"Invalid event data\")"))
            lines.append(self._format_log_line(service, "ValidationError: Invalid event data"))
            return lines
        return []
