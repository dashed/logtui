...
class TestPTYInterceptor:
    ...
    def test_start_interceptor(self, mock_thread, mock_fcntl, mock_close, mock_popen, mock_openpty):
    ...
    @patch('os.getpgid')
    @patch('os.close')
    def test_stop_interceptor_process_not_found(self, mock_close, mock_getpgid, mock_killpg):
