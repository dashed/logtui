...
class TestLogFiltering:
    ...
    def test_log_lines(self):
        ...
        return [
            ...
            LogLine("      server  14:32:01   File \"/app/sentry/api/endpoints/project_events.py\", line 123"),
    ...
    def test_filter_by_error_level(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[1]) == True  # server ERROR
        assert app.matches_filter(test_log_lines[3]) == True  # worker ERROR
        
        # Should not match lines without "ERROR"
        assert app.matches_filter(test_log_lines[0]) == False  # server GET
        assert app.matches_filter(test_log_lines[2]) == False  # worker INFO
        assert app.matches_filter(test_log_lines[4]) == False  # celery-beat INFO
    ...
    def test_filter_by_service_name(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[0]) == True  # server GET
        assert app.matches_filter(test_log_lines[1]) == True  # server ERROR
        assert app.matches_filter(test_log_lines[7]) == True  # server Traceback
        
        # Should not match lines without "server"
        assert app.matches_filter(test_log_lines[2]) == False  # worker INFO
        assert app.matches_filter(test_log_lines[4]) == False  # celery-beat INFO
        assert app.matches_filter(test_log_lines[5]) == False  # webpack
    ...
    def test_filter_by_partial_word(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[5]) == True  # webpack Compiled
    ...
    def test_filter_by_http_method(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[1]) == False  # server ERROR
        assert app.matches_filter(test_log_lines[2]) == False  # worker INFO
    ...
    def test_filter_by_status_code(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[0]) == True  # server GET 200
    ...
    def test_filter_by_file_path(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[8]) == True  # server File "/app/sentry/...
    ...
    def test_filter_by_exception_type(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[9]) == True  # server ValueError
    ...
    def test_filter_by_task_info(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[2]) == True  # worker Task completed
        assert app.matches_filter(test_log_lines[3]) == True  # worker Task failed
    ...
    def test_filter_by_event_id(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[6]) == True  # taskworker event id=abc123
    ...
    def test_filter_no_matches(self, test_log_lines):
        ...
        for log_line in test_log_lines:
            assert app.matches_filter(log_line) == False
    ...
    def test_filter_with_special_characters(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[0]) == True  # server GET /api/0/projects/
    ...
    def test_filter_with_numbers(self, test_log_lines):
        ...
        assert app.matches_filter(test_log_lines[5]) == True  # webpack 1234ms
    ...
    @pytest.mark.parametrize("filter_text,expected_matches", [
    ...
    def test_filter_parametrized(self, test_log_lines, filter_text, expected_matches):
        ...
        for i, log_line in enumerate(test_log_lines):
            ...
            assert actual == expected, f"Filter '{filter_text}' on line {i}: expected {expected}, got {actual}"